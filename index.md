...
In addition, I developed experience with system architecture, operating concepts, and low-level software behavior through coursework in computer systems and reverse engineering. These experiences expanded my understanding of how software interacts with hardware, memory, and operating systems. I also built strong skills in database design and management, writing optimized SQL queries and designing normalized schemas to support scalable and reliable applications.

Communication played a significant role in my academic development. I gained experience writing technical documentation, designing clear project explanations, and translating technical work into structured reports suitable for both technical and non-technical audiences. This strengthened my ability to clearly present ideas, justify technical decisions, and document complex systems in a professional manner.

Throughout my coursework, I gained experience working in collaborative environments by participating in peer code reviews, discussion-based design planning, and shared problem-solving activities. I practiced communicating technical ideas clearly to both technical and non-technical audiences, incorporating feedback to improve my designs and implementations. These experiences strengthened my ability to support team decision-making, adapt to stakeholder needs, and contribute effectively in professional software development environments.

Security awareness was developed through coursework in cybersecurity and software analysis, where I learned the importance of secure coding practices, input validation, and protecting software against common vulnerabilities. I developed a strong appreciation for defensive programming and the role of security at every stage of development.
...
This enhancement demonstrates my ability to design and evaluate computing solutions, apply sound software engineering principles, and communicate technical decisions clearly. It supports collaboration and professional documentation through structured design improvements and maintainable architecture.
...
This enhancement demonstrates my ability to apply algorithmic principles, improve performance through efficient data structures, and manage trade-offs in design decisions. It reflects my ability to evaluate and refine solutions for reliability and scalability.
...
This enhancement demonstrates my ability to apply secure coding practices, handle sensitive data responsibly, and design reliable database-driven applications. It reflects a strong security mindset and attention to protecting system resources and user data.
...
## Code Review
My informal code review video provides a walkthrough of the original functionality of my selected artifacts before any enhancements were made. In the video, I explain how each program worked, identify areas for improvement in structure, logic, efficiency, and security, and justify the planned enhancements. I also explain how the enhancements align with the program’s learning outcomes and demonstrate my ability to clearly communicate technical ideas to both peers and stakeholders. This process is useful because it encourages thoughtful planning, supports collaboration, and allows feedback before implementation.
